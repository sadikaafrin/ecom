                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            <img class="xzoom" id="xzoom-default" width="400" height="400" src="{{asset($product->image)}}" xoriginal="{{asset($product->image)}}" />
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <form action="{{route('cart.add', ['id' => $product->id])}}" method="POST">
                                @csrf
                                <div class="row">
                                    <label class="col-md-8">Card Product Quantity</label>
                                    <div class="col-md-4">
